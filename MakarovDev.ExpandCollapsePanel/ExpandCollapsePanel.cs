...
namespace MakarovDev.ExpandCollapsePanel
{
    ...
    public partial class ExpandCollapsePanel : Panel
    {
        ...
        {
            get { return _statusLable.Text; }
            set
            {
                _statusLable.Text = value;
                if (_statusLable.Text == "OK" || _statusLable.Text == "通过")
                {
                    _statusLable.ForeColor = Color.Green;
                    _btnExpandCollapse.ButtonStyle = ExpandCollapseButton.ExpandButtonStyle.Circle;
                }
                    
                else if (_statusLable.Text == "Not passed" || _statusLable.Text == "未通过")
                    _statusLable.ForeColor = Color.FromArgb(255, 0, 0);
                else
                    _statusLable.ForeColor = Color.Black;
            }
        }
        ...
        private void BtnExpandCollapseExpandCollapse(object sender, ExpandCollapseEventArgs e)
        {
            ...
            {
                if (_statusLable.Text != "OK" && 
                    _statusLable.Text != "通过" &&
                    _statusLable.Text != "In progress" &&
                    _statusLable.Text != "正在检查" &&
                    _statusLable.Text != "未开始" &&
                    _statusLable.Text != "Not started")
        ...
        private void dataGridView1_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            ...
            //  根据填充数据大小设置 DataGrid高度
            dataGridView1.Height = height;
            //  设置宽度
            dataGridView1.Width = dataGridView1.Size.Width + 155;

            //  设置伸缩面板高度
            this.ExpandedHeight = height + 45;
