...
{
    public class USigmaModule : ModuleWithFau
    {
        public USigmaModule(uint moduleNo, ModuleType moduleType, FAUDevice fauDeviceDevice)
        {
            ModuleNo = moduleNo;
            ...
            if (ServerConfig.getInstance().Language)
            {
                ...
                DigitalDataTable.Columns.Add("Operand Notation", Type.GetType("System.String"));
            ...
            else
            {
                ...
                DigitalDataTable.Columns.Add("操作符标志", Type.GetType("System.String"));
