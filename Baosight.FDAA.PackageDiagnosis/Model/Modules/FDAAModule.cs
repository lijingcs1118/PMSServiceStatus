...
{
    public class FDAAModule : BaseModule
    {
        public readonly FDAAPMSService PmsService;

        public FDAAModule(uint moduleNo, ModuleType moduleType, FDAAPMSService pmsService)
        {
            ...
            if (ServerConfig.getInstance().Language)
            {
                ...
                DigitalDataTable.Columns.Add("Operand Notation");
            ...
            else
            {
                ...
                DigitalDataTable.Columns.Add("操作符标志");
