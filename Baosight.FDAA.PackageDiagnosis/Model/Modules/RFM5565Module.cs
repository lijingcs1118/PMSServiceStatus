...
{
    public class RFM5565Module : BaseModule
    {
        public RFM5565Module(uint moduleNo, ModuleType moduleType)
        {
            ModuleNo = moduleNo;
            ...
            if (ServerConfig.getInstance().Language)
            {
                ...
                DigitalDataTable.Columns.Add("Rfm Address", Type.GetType("System.String"));
            ...
            else
            {
                ...
                DigitalDataTable.Columns.Add("反射内存网地址", Type.GetType("System.String"));
