...
namespace PMSServiceStatus.Forms
{
    public partial class ExportFrm : Form
    {
        ...
        public ExportFrm(IEnumerable<CostomDataGridView> dataGridViews)
        {
            ...
            InitializeComponent();
            txtExportPath.Text = FdaaHelper.CreateInstance().DiagnosePath;
            SetLanguage();
        }
        ...
        private void SetLanguage()
        {
            ...
            lblSaveText.Text = language ?  "Save exported file as :": "另存为导出文件：";
            btnBrowse.Text = language ?  "Browse . . .": "浏览 . . .";
            lblPreview.Text = language ?  "Preview:": "预览：";
            btnCopy.Text = language ?  "Copy to Clipboard": "复制到剪切板";
