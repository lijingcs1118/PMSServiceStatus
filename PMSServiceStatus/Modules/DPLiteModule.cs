...
{
    class DPLiteModule : BaseModule
    {
        public DPLiteModule(UInt32 moduleNo, PMSServiceStatus.IOConfig.MODULE_TYPE moduleType)
        {
            ModuleNo = moduleNo;
            ...
            if(ServerConfig.getInstance().Language)
            {
                ...
                DigitalDataTable.Columns.Add("Offset", System.Type.GetType("System.String"));
            ...
            else
            {
                ...
                DigitalDataTable.Columns.Add("偏移地址", System.Type.GetType("System.String"));
