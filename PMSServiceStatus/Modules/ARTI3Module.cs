...
{
    class ARTI3Module : BaseModule
    {
        public ARTI3Module(UInt32 moduleNo, PMSServiceStatus.IOConfig.MODULE_TYPE moduleType)
        {
            ModuleNo = moduleNo;
            ...
            if(ServerConfig.getInstance().Language)
            {
                ...
                AnalogDataTable.Columns.Add("ARTI3 Symbol");
                ...
                DigitalDataTable.Columns.Add("ARTI3 Symbol");
            ...
            else
            {
                ...
                AnalogDataTable.Columns.Add("ARTI3 符号");
                ...
                DigitalDataTable.Columns.Add("ARTI3 符号");
